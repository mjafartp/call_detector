...
/** CallDetectorPlugin */
class CallDetectorPlugin: FlutterPlugin, MethodCallHandler, ActivityAware, PluginRegistry.RequestPermissionsResultListener {
  companion object {
    const val PLUGIN_NAME = "com.thedevbuddy.call_detector"
    const val CALLBACK_SHAREDPREFERENCES_KEY = "callDetectorPluginCallbackHandler"
    const val CALLBACK_USER_SHAREDPREFERENCES_KEY = "callDetectorPluginCallbackHandlerUser"
  }
  ...
  override fun onMethodCall(call: MethodCall, result: Result) {
    ...
    if (call.method == "initialize" && arguments?.size == 2) {
      ...
      val receiver = ComponentName(context, CallDetectorCallReceiver::class.java)
